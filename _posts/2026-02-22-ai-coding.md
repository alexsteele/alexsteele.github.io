...
- I estimate productivity improvements in the 3-10x range for pure software
  ...
  work.
- They work best when you work methodically: planning first, coming up with
  test cases, then implementing. But they work surprisingly well in pure-vibe
  mode as well, where you leave them entirely to their own devices and spot-
  check the output. The code can still be repetitive and ugly, but they're
  usually able to improve it with some hints.
